/*
yang bisa di ubah ubah icon ( ErlanggaOfficial )
=========================
fas fa-rocket
fas fa-bolt
...
const faqData = [
    {
        question: 'Apa itu ErlanggaHost?',
        answer: '<ul>ErlanggaHost adalah penyedia layanan hosting terkemuka yang berfokus pada panel Pterodactyl untuk server game dan aplikasi. Kami menawarkan hosting berkualitas premium dengan harga terjangkau dan performa optimal.</ul>'
    },
    {
        question: 'Bagaimana cara membeli hosting di ErlanggaHost?',
        answer: '<ul>Untuk membeli hosting, Anda perlu mengisi "Informasi Akun" Anda, memilih "Paket Hosting" yang diinginkan, memilih "Metode Pembayaran" (QRIS, Gopay, atau DANA), lalu memeriksa "Ringkasan Pesanan". Setelah itu, klik tombol "BELI" untuk melanjutkan konfirmasi pembayaran dan aktivasi layanan melalui WhatsApp Admin Erlangga.</ul>'
    },
    {
    ...
    {
        question: 'Apakah ErlanggaHost menyediakan layanan support?',
